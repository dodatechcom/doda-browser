...
static const RedirEntry kRedirMap[] = {
    ...
    {"doda", "chrome://sundaram/content/aboutDoda.html",
     nsIAboutModule::ALLOW_SCRIPT | nsIAboutModule::IS_SECURE_CHROME_UI},
    ...
    {"networking", "chrome://global/content/aboutNetworking.html",
     nsIAboutModule::ALLOW_SCRIPT},
    {"permissions", "chrome://permissions/content/aboutPermissions.html",
     nsIAboutModule::ALLOW_SCRIPT | nsIAboutModule::IS_SECURE_CHROME_UI},
...
#  endif
         nsIAboutModule::ALLOW_SCRIPT},
#endif
    {"tutorial", "chrome://tutorial/content/aboutTutorial.html",
     nsIAboutModule::ALLOW_SCRIPT | nsIAboutModule::IS_SECURE_CHROME_UI},
