...
about-application-heading =
    .label = { -brand-short-name }
    .description = Information about your browser version.

about-application-get-latest =
    .label = Get the latest version
    .description = Download the newest version of { -brand-short-name } from { -vendor-short-name }.
